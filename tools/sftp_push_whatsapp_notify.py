#!/usr/bin/env python3
"""SFTP WhatsApp notify ringbells + team prefs, then migrate/seed/clear."""
...
FILES = [
    ...
    "app/Services/AppDevelopment/AppDevelopmentWhatsAppNotifyService.php",
    "app/Http/Controllers/AppDevelopment/TeamController.php",
    "app/Http/Requests/AppDevelopment/UpdateTeamMemberRequest.php",
    "database/migrations/2026_08_25_100000_add_whatsapp_fields_to_app_development_members.php",
    "database/seeders/AppDevelopmentMemberSeeder.php",
    "database/seeders/WorkspaceUserSeeder.php",
    "database/seeders/KamanWhatsappChatbotInstanceSeeder.php",
    ...
    "resources/views/app-development/team/index.blade.php",
]
