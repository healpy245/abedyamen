#!/usr/bin/env python3
"""SFTP inline priority/status pickers, then clear cache."""
...
FILES = [
    ...
    "app/Http/Requests/AppDevelopment/UpdateTicketPriorityRequest.php",
    "app/Http/Requests/AppDevelopment/UpdateTicketStatusRequest.php",
    ...
    "resources/views/app-development/partials/inline-field.blade.php",
