...
FILES = [
    "app/Exceptions/FormWorkflowPausedException.php",
    "app/Models/FormWorkflowRun.php",
    "app/Services/Form/FormWorkflowRunService.php",
    "app/Services/Haat/KamanHttp.php",
    "app/Services/Haat/HaatMenuParser.php",
    "app/Services/Haat/KamanMenuWriter.php",
    "app/Services/Haat/KamanMenuSyncPlanner.php",
    "app/Services/Haat/KamanCashierClient.php",
    "app/Services/AI/Workflows/HaatMenuCopyWorkflow.php",
    "app/Services/AI/FormWorkflowRunner.php",
    "app/Http/Controllers/FormController.php",
    "routes/web.php",
    "database/migrations/2026_09_08_140000_create_form_workflow_runs_table.php",
    "lang/en/form.php",
    "lang/ar/form.php",
    "lang/he/form.php",
