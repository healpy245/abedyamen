#!/usr/bin/env python3
"""SFTP the Malan closing-question / callback / nudge changes, then migrate + clear."""
...
FILES = [
    ...
    "app/Jobs/ProcessCampaignConversationJob.php",
    "app/Jobs/SendCampaignFollowUpNudgeJob.php",
    "app/Services/AiChatbot/AiChatbotService.php",
    "app/Services/Malan/Campaigns/CampaignConversationBurstService.php",
    "app/Services/Malan/Campaigns/CampaignInsightService.php",
    "app/Services/Malan/MalanConversationContextService.php",
    "app/Services/Malan/MalanConversationMemoryService.php",
    "database/migrations/2026_08_26_140000_refresh_malan_campaign_closing_question_copy.php",
    "tests/Feature/Malan/MalanCampaignsTest.php",
]
