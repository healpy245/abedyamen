Param(
    [string]$HotDrinksFolder = "$(Split-Path $PSScriptRoot -Parent)\public\HotDrinks"
)

Write-Host "Converting images in '$HotDrinksFolder' to JPG..." -ForegroundColor Cyan
...
$files = Get-ChildItem -LiteralPath $HotDrinksFolder -File | Where-Object {
